...
button.addEventListener('click', function (e) {
    ...
    window.setTimeout(counterOut, 800)
    console.log(clickCounter)
    button.appendChild(clickCounter)
    clickCounter.textContent = '+1'
    e.target
    clickCounter.style.left = e.pageX + 'px'
    clickCounter.style.top = e.pageY + 'px'
    ...
    if (score.textContent == 1) {
        achivementOn()
        window.setTimeout(achivementOff, 900)
